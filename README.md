...
**АРI-сервис, должны быть реализованы:**
...
**Docker:**
- Все сервисы должны подниматься одной командой через docker
...
│   │   ├── main.go
│   │   └── main_test.go
│   └── kafka-logger/     # Kafka logger сервис
│       └── main.go
├── internal/
│   ├── app/
│   │   ├── models/       # Модели данных
│   │   │   └── task.go
│   │   ├── pb/           # Protocol Buffers файлы
│   │   │   ├── task.proto
│   │   │   ├── task.pb.go
│   │   │   └── task_grpc.pb.go
...
├── Dockerfile.db         # Dockerfile для DB сервиса
├── Dockerfile.kafka      # Dockerfile для Kafka logger
├── go.mod
├── go.sum
└── README.md
```
